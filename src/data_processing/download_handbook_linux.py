#!/usr/bin/env python3
"""
Скрипт для скачивания HTML страниц из Яндекс Хендбука по Linux.

Использует Selenium для обхода защиты и поддерживает ручное прохождение капчи.

Использование:
    uv run python -m src.data_processing.download_handbook_linux
    
    # Или напрямую
    uv run python src/data_processing/download_handbook_linux.py
"""
...
OUTPUT_DIR = RAW_DATA_DIR / "linux"

# URL хендбука
HANDBOOK_URL = "https://education.yandex.ru/handbook/linux"
...
def main():
    ...
    print("=" * 60)
    print("🚀 Яндекс Хендбук Linux Downloader")
    print("=" * 60)
