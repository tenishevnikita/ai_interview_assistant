#!/usr/bin/env python3
"""
Скрипт для скачивания HTML страниц из Яндекс Хендбука по ML.

Использует Selenium для обхода защиты и поддерживает ручное прохождение капчи.

Использование:
    uv run python -m src.data_processing.download_handbook_ml
    
    # Или напрямую
    uv run python src/data_processing/download_handbook_ml.py
"""
...
def main():
    ...
    print("=" * 60)
    print("🚀 Яндекс Хендбук ML Downloader")
    print("=" * 60)
