#!/usr/bin/env python3
"""
Скрипт для скачивания HTML страниц из Яндекс Хендбука по Алгоритмам.

Использует Selenium для обхода защиты и поддерживает ручное прохождение капчи.

Использование:
    uv run python -m src.data_processing.download_handbook_algo
    
    # Или напрямую
    uv run python src/data_processing/download_handbook_algo.py
"""
...
OUTPUT_DIR = RAW_DATA_DIR / "algorithms"

# URL хендбука
HANDBOOK_URL = "https://education.yandex.ru/handbook/algorithms"
...
def main():
    ...
    print("=" * 60)
    print("🚀 Яндекс Хендбук Algorithms Downloader")
    print("=" * 60)
