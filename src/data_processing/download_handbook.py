#!/usr/bin/env python3
"""
Скрипт для скачивания HTML страниц из Яндекс Хендбука по Python.
...
Использование:
    ...
    # Или напрямую
    uv run python src/data_processing/download_handbook.py
"""
...
OUTPUT_DIR = RAW_DATA_DIR / "python"
...
def main():
    ...
    print("=" * 60)
    print("🚀 Яндекс Хендбук Downloader")
    print("=" * 60)
    ...
    try:
        handbook_url = "https://education.yandex.ru/handbook/python"
