#!/usr/bin/env python3
"""
Скрипт для скачивания HTML страниц из Яндекс Хендбука по Математике.

Использует Selenium для обхода защиты и поддерживает ручное прохождение капчи.

Использование:
    uv run python -m src.data_processing.download_handbook_math
    
    # Или напрямую
    uv run python src/data_processing/download_handbook_math.py
"""
...
OUTPUT_DIR = RAW_DATA_DIR / "math"

# URL хендбука
HANDBOOK_URL = "https://education.yandex.ru/handbook/math"
...
def main():
    ...
    print("=" * 60)
    print("🚀 Яндекс Хендбук Math Downloader")
    print("=" * 60)
